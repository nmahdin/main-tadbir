...
* @returns {Date}
*/
function newDate$1() {for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
  if (args.length > 1) {
...
function _addMonths(date, amount, options) {
  ...
  if (isNaN(amount)) return _constructFrom((options === null || options === void 0 ? void 0 : options.in) || date, NaN);
  if (!amount) return _date;
  var dayOfMonth = getDate$1(_date);
  ...
  if (dayOfMonth >= getDate$1(endOfDesiredMonth)) return endOfDesiredMonth;else
  {
...
function _addBusinessDays(date, amount, options) {
  ...
  if (startedOnWeekend && _isWeekend(_date, options) && amount !== 0) {
    if (_isFriday(_date, options)) setDate$1(_date, getDate$1(_date) + (sign < 0 ? 1 : -2));
  }
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/constructNow.js
/**
* @name constructNow
* @category Generic Helpers
...
function _differenceInCalendarMonths(laterDate, earlierDate, options) {
  ...
  var monthsDiff = getMonth$1(laterDate_) - getMonth$1(earlierDate_);
...
function _startOfQuarter(date, options) {
  var _date = _toDate(date, options === null || options === void 0 ? void 0 : options.in);
  var currentMonth = getMonth$1(_date);
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/endOfToday.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/endOfTomorrow.js
/**
...
function _endOfTomorrow(options) {
  ...
  var month = getMonth$1(now);
  var day = getDate$1(now);
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/endOfYesterday.js
/**
...
var _formatters = {
  ...
  Q: function Q(date, token, localize) {
    var quarter = Math.ceil((getMonth$1(date) + 1) / 3);
    switch (token) {
  ...
  d: function d(date, token, localize) {
    if (token === "do") return localize.ordinalNumber(getDate$1(date), { unit: "date" });
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/formatDistanceToNow.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/formatDistanceToNowStrict.js
/**
...
function _getDate(date, options) {
  return getDate$1(_toDate(date, options === null || options === void 0 ? void 0 : options.in));
}
//#endregion
...
function _getDaysInMonth(date, options) {
  var _date = _toDate(date, options === null || options === void 0 ? void 0 : options.in);
  var year = getFullYear(_date);
  var monthIndex = getMonth$1(_date);
...
function _isLeapYear(date, options) {
  return isLeapYear$1(getFullYear(_toDate(date, options === null || options === void 0 ? void 0 : options.in)));
}
//#endregion
...
function _getDecade(date, options) {
  var year = getFullYear(_toDate(date, options === null || options === void 0 ? void 0 : options.in));
...
function _getMonth(date, options) {
  return getMonth$1(_toDate(date, options === null || options === void 0 ? void 0 : options.in));
}
//#endregion
...
function _isExists(year, month, day) {
  var date = newDate$1(year, month, day);
...
function _isFirstDayOfMonth(date, options) {
  return getDate$1(_toDate(date, options === null || options === void 0 ? void 0 : options.in)) === 1;
}
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isFuture.js
/**
* @name isFuture
* @category Common Helpers
...
var EraParser = /*#__PURE__*/function (_Parser) {function EraParser() {var _this3;_classCallCheck(this, EraParser);for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {args[_key6] = arguments[_key6];}_this3 = _callSuper(this, EraParser, [].concat(args));_defineProperty(_this3, "priority",
...
function isLeapYearIndex$1(year) {
  return _isLeapYear(newDate$1(year, 0));
}
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/parse/_lib/parsers/YearParser.js
var YearParser = /*#__PURE__*/function (_Parser2) {function YearParser() {var _this4;_classCallCheck(this, YearParser);for (var _len7 = arguments.length, args = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {args[_key7] = arguments[_key7];}_this4 = _callSuper(this, YearParser, [].concat(args));_defineProperty(_this4, "priority",
...
var LocalWeekYearParser = /*#__PURE__*/function (_Parser3) {function LocalWeekYearParser() {var _this5;_classCallCheck(this, LocalWeekYearParser);for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {args[_key8] = arguments[_key8];}_this5 = _callSuper(this, LocalWeekYearParser, [].concat(args));_defineProperty(_this5, "priority",
...
var QuarterParser = /*#__PURE__*/function (_Parser6) {function QuarterParser() {var _this8;_classCallCheck(this, QuarterParser);for (var _len1 = arguments.length, args = new Array(_len1), _key1 = 0; _key1 < _len1; _key1++) {args[_key1] = arguments[_key1];}_this8 = _callSuper(this, QuarterParser, [].concat(args));_defineProperty(_this8, "priority",
    ...
    "c",
    "t",
    "T"]);return _this8;}_inherits(QuarterParser, _Parser6);return _createClass(QuarterParser, [{ key: "parse", value: function parse(dateString, token, match) {switch (token) {case "Q":case "QQ":return parseNDigits(token.length, dateString);case "Qo":return match.ordinalNumber(dateString, { unit: "quarter" });case "QQQ":return match.quarter(dateString, { width: "abbreviated", context: "formatting" }) || match.quarter(dateString, { width: "narrow", context: "formatting" });case "QQQQQ":return match.quarter(dateString, { width: "narrow", context: "formatting" });default:return match.quarter(dateString, { width: "wide", context: "formatting" }) || match.quarter(dateString, { width: "abbreviated", context: "formatting" }) || match.quarter(dateString, { width: "narrow", context: "formatting" });}} }, { key: "validate", value: function validate(_date, value) {return value >= 1 && value <= 4;} }, { key: "set", value: function set(date, _flags, value) {setMonth$1(date, (value - 1) * 3, 1);date.setHours(0, 0, 0, 0);return date;} }]);}(Parser);


//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/parse/_lib/parsers/StandAloneQuarterParser.js
var StandAloneQuarterParser = /*#__PURE__*/function (_Parser7) {function StandAloneQuarterParser() {var _this9;_classCallCheck(this, StandAloneQuarterParser);for (var _len10 = arguments.length, args = new Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {args[_key10] = arguments[_key10];}_this9 = _callSuper(this, StandAloneQuarterParser, [].concat(args));_defineProperty(_this9, "priority",
    ...
    "c",
    "t",
    "T"]);return _this9;}_inherits(StandAloneQuarterParser, _Parser7);return _createClass(StandAloneQuarterParser, [{ key: "parse", value: function parse(dateString, token, match) {switch (token) {case "q":case "qq":return parseNDigits(token.length, dateString);case "qo":return match.ordinalNumber(dateString, { unit: "quarter" });case "qqq":return match.quarter(dateString, { width: "abbreviated", context: "standalone" }) || match.quarter(dateString, { width: "narrow", context: "standalone" });case "qqqqq":return match.quarter(dateString, { width: "narrow", context: "standalone" });default:return match.quarter(dateString, { width: "wide", context: "standalone" }) || match.quarter(dateString, { width: "abbreviated", context: "standalone" }) || match.quarter(dateString, { width: "narrow", context: "standalone" });}} }, { key: "validate", value: function validate(_date, value) {return value >= 1 && value <= 4;} }, { key: "set", value: function set(date, _flags, value) {setMonth$1(date, (value - 1) * 3, 1);date.setHours(0, 0, 0, 0);return date;} }]);}(Parser);


//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/parse/_lib/parsers/MonthParser.js
var MonthParser = /*#__PURE__*/function (_Parser8) {function MonthParser() {var _this0;_classCallCheck(this, MonthParser);for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {args[_key11] = arguments[_key11];}_this0 = _callSuper(this, MonthParser, [].concat(args));_defineProperty(_this0, "incompatibleTokens",
    [
    "Y",
    "R",
    "q",
...
var StandAloneMonthParser = /*#__PURE__*/function (_Parser9) {function StandAloneMonthParser() {var _this1;_classCallCheck(this, StandAloneMonthParser);for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {args[_key12] = arguments[_key12];}_this1 = _callSuper(this, StandAloneMonthParser, [].concat(args));_defineProperty(_this1, "priority",
    ...
    "c",
    "t",
    "T"]);return _this1;}_inherits(StandAloneMonthParser, _Parser9);return _createClass(StandAloneMonthParser, [{ key: "parse", value: function parse(dateString, token, match) {var valueCallback = function valueCallback(value) {return value - 1;};switch (token) {case "L":return mapValue(parseNumericPattern(numericPatterns.month, dateString), valueCallback);case "LL":return mapValue(parseNDigits(2, dateString), valueCallback);case "Lo":return mapValue(match.ordinalNumber(dateString, { unit: "month" }), valueCallback);case "LLL":return match.month(dateString, { width: "abbreviated", context: "standalone" }) || match.month(dateString, { width: "narrow", context: "standalone" });case "LLLLL":return match.month(dateString, { width: "narrow", context: "standalone" });default:return match.month(dateString, { width: "wide", context: "standalone" }) || match.month(dateString, { width: "abbreviated", context: "standalone" }) || match.month(dateString, { width: "narrow", context: "standalone" });}} }, { key: "validate", value: function validate(_date, value) {return value >= 0 && value <= 11;} }, { key: "set", value: function set(date, _flags, value) {setMonth$1(date, value, 1);date.setHours(0, 0, 0, 0);return date;} }]);}(Parser);
...
var LocalWeekParser = /*#__PURE__*/function (_Parser0) {function LocalWeekParser() {var _this10;_classCallCheck(this, LocalWeekParser);for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {args[_key13] = arguments[_key13];}_this10 = _callSuper(this, LocalWeekParser, [].concat(args));_defineProperty(_this10, "priority",
...
var ISOWeekParser = /*#__PURE__*/function (_Parser1) {function ISOWeekParser() {var _this11;_classCallCheck(this, ISOWeekParser);for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {args[_key14] = arguments[_key14];}_this11 = _callSuper(this, ISOWeekParser, [].concat(args));_defineProperty(_this11, "priority",
...
var DateParser = /*#__PURE__*/function (_Parser10) {function DateParser() {var _this12;_classCallCheck(this, DateParser);for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {args[_key15] = arguments[_key15];}_this12 = _callSuper(this, DateParser, [].concat(args));_defineProperty(_this12, "priority",
    ...
    "c",
    "t",
    "T"]);return _this12;}_inherits(DateParser, _Parser10);return _createClass(DateParser, [{ key: "parse", value: function parse(dateString, token, match) {switch (token) {case "d":return parseNumericPattern(numericPatterns.date, dateString);case "do":return match.ordinalNumber(dateString, { unit: "date" });default:return parseNDigits(token.length, dateString);}} }, { key: "validate", value: function validate(date, value) {var isLeapYear = isLeapYearIndex$1(getFullYear(date));var month = getMonth$1(date);if (isLeapYear) return value >= 1 && value <= DAYS_IN_MONTH_LEAP_YEAR[month];else return value >= 1 && value <= DAYS_IN_MONTH[month];} }, { key: "set", value: function set(date, _flags, value) {setDate$1(date, value);date.setHours(0, 0, 0, 0);return date;} }]);}(Parser);


//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/parse/_lib/parsers/DayOfYearParser.js
var DayOfYearParser = /*#__PURE__*/function (_Parser11) {function DayOfYearParser() {var _this13;_classCallCheck(this, DayOfYearParser);for (var _len16 = arguments.length, args = new Array(_len16), _key16 = 0; _key16 < _len16; _key16++) {args[_key16] = arguments[_key16];}_this13 = _callSuper(this, DayOfYearParser, [].concat(args));_defineProperty(_this13, "priority",
    ...
    "c",
    "t",
    "T"]);return _this13;}_inherits(DayOfYearParser, _Parser11);return _createClass(DayOfYearParser, [{ key: "parse", value: function parse(dateString, token, match) {switch (token) {case "D":case "DD":return parseNumericPattern(numericPatterns.dayOfYear, dateString);case "Do":return match.ordinalNumber(dateString, { unit: "date" });default:return parseNDigits(token.length, dateString);}} }, { key: "validate", value: function validate(date, value) {if (isLeapYearIndex$1(getFullYear(date))) return value >= 1 && value <= 366;else return value >= 1 && value <= 365;} }, { key: "set", value: function set(date, _flags, value) {setMonth$1(date, 0, value);date.setHours(0, 0, 0, 0);return date;} }]);}(Parser);
...
var DayParser = /*#__PURE__*/function (_Parser12) {function DayParser() {var _this14;_classCallCheck(this, DayParser);for (var _len17 = arguments.length, args = new Array(_len17), _key17 = 0; _key17 < _len17; _key17++) {args[_key17] = arguments[_key17];}_this14 = _callSuper(this, DayParser, [].concat(args));_defineProperty(_this14, "priority",
...
var LocalDayParser = /*#__PURE__*/function (_Parser13) {function LocalDayParser() {var _this15;_classCallCheck(this, LocalDayParser);for (var _len18 = arguments.length, args = new Array(_len18), _key18 = 0; _key18 < _len18; _key18++) {args[_key18] = arguments[_key18];}_this15 = _callSuper(this, LocalDayParser, [].concat(args));_defineProperty(_this15, "priority",
...
var StandAloneLocalDayParser = /*#__PURE__*/function (_Parser14) {function StandAloneLocalDayParser() {var _this16;_classCallCheck(this, StandAloneLocalDayParser);for (var _len19 = arguments.length, args = new Array(_len19), _key19 = 0; _key19 < _len19; _key19++) {args[_key19] = arguments[_key19];}_this16 = _callSuper(this, StandAloneLocalDayParser, [].concat(args));_defineProperty(_this16, "priority",
...
var ISODayParser = /*#__PURE__*/function (_Parser15) {function ISODayParser() {var _this17;_classCallCheck(this, ISODayParser);for (var _len20 = arguments.length, args = new Array(_len20), _key20 = 0; _key20 < _len20; _key20++) {args[_key20] = arguments[_key20];}_this17 = _callSuper(this, ISODayParser, [].concat(args));_defineProperty(_this17, "priority",
...
var AMPMParser = /*#__PURE__*/function (_Parser16) {function AMPMParser() {var _this18;_classCallCheck(this, AMPMParser);for (var _len21 = arguments.length, args = new Array(_len21), _key21 = 0; _key21 < _len21; _key21++) {args[_key21] = arguments[_key21];}_this18 = _callSuper(this, AMPMParser, [].concat(args));_defineProperty(_this18, "priority",
...
var AMPMMidnightParser = /*#__PURE__*/function (_Parser17) {function AMPMMidnightParser() {var _this19;_classCallCheck(this, AMPMMidnightParser);for (var _len22 = arguments.length, args = new Array(_len22), _key22 = 0; _key22 < _len22; _key22++) {args[_key22] = arguments[_key22];}_this19 = _callSuper(this, AMPMMidnightParser, [].concat(args));_defineProperty(_this19, "priority",
...
var DayPeriodParser = /*#__PURE__*/function (_Parser18) {function DayPeriodParser() {var _this20;_classCallCheck(this, DayPeriodParser);for (var _len23 = arguments.length, args = new Array(_len23), _key23 = 0; _key23 < _len23; _key23++) {args[_key23] = arguments[_key23];}_this20 = _callSuper(this, DayPeriodParser, [].concat(args));_defineProperty(_this20, "priority",
...
var Hour1to12Parser = /*#__PURE__*/function (_Parser19) {function Hour1to12Parser() {var _this21;_classCallCheck(this, Hour1to12Parser);for (var _len24 = arguments.length, args = new Array(_len24), _key24 = 0; _key24 < _len24; _key24++) {args[_key24] = arguments[_key24];}_this21 = _callSuper(this, Hour1to12Parser, [].concat(args));_defineProperty(_this21, "priority",
...
var Hour0To11Parser = /*#__PURE__*/function (_Parser21) {function Hour0To11Parser() {var _this23;_classCallCheck(this, Hour0To11Parser);for (var _len26 = arguments.length, args = new Array(_len26), _key26 = 0; _key26 < _len26; _key26++) {args[_key26] = arguments[_key26];}_this23 = _callSuper(this, Hour0To11Parser, [].concat(args));_defineProperty(_this23, "priority",
...
var MinuteParser = /*#__PURE__*/function (_Parser23) {function MinuteParser() {var _this25;_classCallCheck(this, MinuteParser);for (var _len28 = arguments.length, args = new Array(_len28), _key28 = 0; _key28 < _len28; _key28++) {args[_key28] = arguments[_key28];}_this25 = _callSuper(this, MinuteParser, [].concat(args));_defineProperty(_this25, "priority",
...
var SecondParser = /*#__PURE__*/function (_Parser24) {function SecondParser() {var _this26;_classCallCheck(this, SecondParser);for (var _len29 = arguments.length, args = new Array(_len29), _key29 = 0; _key29 < _len29; _key29++) {args[_key29] = arguments[_key29];}_this26 = _callSuper(this, SecondParser, [].concat(args));_defineProperty(_this26, "priority",
...
var FractionOfSecondParser = /*#__PURE__*/function (_Parser25) {function FractionOfSecondParser() {var _this27;_classCallCheck(this, FractionOfSecondParser);for (var _len30 = arguments.length, args = new Array(_len30), _key30 = 0; _key30 < _len30; _key30++) {args[_key30] = arguments[_key30];}_this27 = _callSuper(this, FractionOfSecondParser, [].concat(args));_defineProperty(_this27, "priority",
...
var ISOTimezoneWithZParser = /*#__PURE__*/function (_Parser26) {function ISOTimezoneWithZParser() {var _this28;_classCallCheck(this, ISOTimezoneWithZParser);for (var _len31 = arguments.length, args = new Array(_len31), _key31 = 0; _key31 < _len31; _key31++) {args[_key31] = arguments[_key31];}_this28 = _callSuper(this, ISOTimezoneWithZParser, [].concat(args));_defineProperty(_this28, "priority",
...
var TimestampSecondsParser = /*#__PURE__*/function (_Parser28) {function TimestampSecondsParser() {var _this30;_classCallCheck(this, TimestampSecondsParser);for (var _len33 = arguments.length, args = new Array(_len33), _key33 = 0; _key33 < _len33; _key33++) {args[_key33] = arguments[_key33];}_this30 = _callSuper(this, TimestampSecondsParser, [].concat(args));_defineProperty(_this30, "priority",
...
function _isMatch(dateStr, formatStr, options) {
  return _isValid(_parse(dateStr, formatStr, newDate$1(), options));
}
//#endregion
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isPast.js
/**
* @name isPast
* @category Common Helpers
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisHour.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisISOWeek.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisMinute.js
/**
* @name isThisMinute
* @category Minute Helpers
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisMonth.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisQuarter.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisSecond.js
/**
* @name isThisSecond
* @category Second Helpers
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisWeek.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isThisYear.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isToday.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isTomorrow.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/isYesterday.js
/**
...
function _lastDayOfQuarter(date, options) {
  var date_ = _toDate(date, options === null || options === void 0 ? void 0 : options.in);
  var currentMonth = getMonth$1(date_);
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/newDate.js
/**
* @name newDate
* @category Common Helpers
...
*/
function _newDate(year, monthIndex, date) {var hours = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;var minutes = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;var seconds = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;var ms = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/setDefaultOptions.js
/**
...
function _setQuarter(date, quarter, options) {
  var date_ = _toDate(date, options === null || options === void 0 ? void 0 : options.in);
  var diff = quarter - (Math.trunc(getMonth$1(date_) / 3) + 1);
  return _setMonth(date_, getMonth$1(date_) + diff * 3);
}
//#endregion
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/startOfToday.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/startOfTomorrow.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/startOfYesterday.js
/**
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/index.js
var date_fns_exports = /* @__PURE__ */__exportAll({
  ...
  newDate: function newDate() {return _newDate;},
...
//#endregion
//#region ../../../../../../../../tmp/date-fns-jalali/date-fns/_entries/cdn.js
